...
import { ChevronRight, Layers, Layout, List } from "lucide-react";
import { useNarrativeStore } from "@/store/narrativeStore";
import { TemplateName } from "@/lib/types";
import { cn } from "@/lib/utils";

const templates: { name: TemplateName; label: string }[] = [
  { name: "ZoomReveal", label: "Zoom" },
  { name: "LinearStoryboard", label: "Linear" },
  { name: "FlyoverMap", label: "Flyover" },
  { name: "ContrastSplit", label: "Split" },
  { name: "PriorityLadder", label: "Ladder" },
];
